import { TreeNode, Tree, MenuItem } from 'primeng/primeng';
import { Message } from 'primeng/components/common/api';
import { Component, OnInit, ViewChild } from '@angular/core';
import { NodeService } from './node.service';

@Component({
  selector: 'app-tree-dn',
  templateUrl: './tree-dn.component.html',
  styleUrls: ['./tree-dn.component.css'],
  providers: [NodeService]
})
export class TreeDnComponent implements OnInit {
