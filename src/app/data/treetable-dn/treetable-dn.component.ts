import { NodeService } from './../tree-dn/node.service';
import { Message } from 'primeng/components/common/api';
import { TreeNode, MenuItem } from 'primeng/primeng';
import { Component, OnInit } from '@angular/core';

@Component({
  selector: 'app-treetable-dn',
  templateUrl: './treetable-dn.component.html',
  styleUrls: ['./treetable-dn.component.css'],
  providers:[NodeService]
})
export class TreetableDnComponent implements OnInit {
  msgs: Message[];
